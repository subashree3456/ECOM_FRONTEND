...
export default function Delete({setShow,show,handleDlete}) {
        ...
        <div className="w-full max-w-md bg-white shadow-lg rounded-lg p-6 relative">
           ...
           <svg xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="flex flex-col space-y-2">
                <button type="button"
                    className="px-4 py-2 rounded-lg text-white text-sm tracking-wide bg-red-500 hover:bg-red-600 active:bg-red-500" onClick={handleDlete}>Delete</button>
                <button type="button"
                    className="px-4 py-2 rounded-lg text-gray-800 text-sm tracking-wide bg-gray-200 hover:bg-gray-300 active:bg-gray-200"  onClick={()=>setShow(false)}>Cancel</button>
            </div>
        </div>
    </div>
    )
